...
// $Id: RF12.cpp 6019 2010-09-13 19:37:32Z jcw $
...
uint8_t rf12_recvDone () {
    if (rxstate == TXRECV && (rxfill >= rf12_len + 2 || rxfill >= RF_MAX)) {
        rxstate = TXIDLE;
...
//
//char rf12_lowbat () {
//  Serial.print("lowbat call: ");
//  Serial.print(rf12_control(0x0000));
//    return (rf12_control(0x0000) & RF_LBD_BIT) != 0;
//}
//
